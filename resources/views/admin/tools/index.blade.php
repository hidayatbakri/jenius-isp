              ...
              <tr>
                ...
                <td>
                  <form action="/admin/odc/{{ $row->id }}" method="post">
                    ...
                    <a href="/admin/odc/{{ $row->id }}/edit" class="badge btn-success">Edit</a>
              ...
              <tr>
                ...
                <td>
                  <form action="/admin/tools/{{ $rodp->id }}" method="post">
                    ...
                    <a href="/admin/odp/{{ $rodp->id }}/edit" class="badge btn-success">Edit</a>
                    <button class="badge btn-danger" onclick="return confirm('Apakah anda yakin?')">Hapus</button>
                  </form>
                </td>
              </tr>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="form-group" id="show-port">
...
<script>
  $('#type').on('click', function() {
    if ($('#type').val() == 0) {
      ...
      $('#show-olt').html(`<label for="type">Olt: </label>
            <select name="olt_id" id="olt_id" class="form-control @error('olt_id') is-invalid @enderror">
              @foreach($olt as $o)
              <option value="{{ $o['id'] }}">{{ $o['host'] }}</option>
              @endforeach
